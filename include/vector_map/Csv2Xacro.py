...
class Csv2Xacro(object):
    ...
    def writeXacro(self):
        ...
        root.setAttribute( 'name', 'vector_map' )
        ...
        tempChild.setAttribute('filename','$(find vector_map)/urdf/macros.urdf.xacro')
        root.appendChild(tempChild)

        # Create comment
        comment = doc.createComment('The world frame is at the lower left corner of map')
        root.appendChild(comment)
